        ...
        children: [
          AppBar(
            ...
            leading: IconButton(
              onPressed: () => Get.back(),
              icon:
                  Icon(Icons.arrow_back_ios, color: ColorsManager.WHITE_COLOR),
            ),
          ),
          Expanded(
              child: FutureBuilder<RecentTransactionsModel?>(
            future: home.getHome(),
            builder: (
                      ...
                      itemBuilder: (BuildContext ctxt, int index) {
                        return ListTile(
                          leading: AvatarView(
                              ...
                              imagePath:
                                  "${userInfo.data![index].currencies!.logo == null ? ImageManager.weCoin_logo : userInfo.data![index].currencies!.logo}",
                          ...
                          subtitle: Text(
                              "${userInfo.data![index].createdAt!.substring(0, 10)}",
                              style: TextStyle(
                                fontSize: 12.sp,
                          ...
                          trailing: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 5),
                              if (userInfo.data![index].transactionType ==
                                  "send")
                                Text("${userInfo.data![index].transactionType}",
                                    style: TextStyle(
                                        fontSize: 12,
