...
class Auth_Provider with ChangeNotifier {
  ...
  Future sign_up(BuildContext context, String full_name, String email,
      String phone, String password, String country) async {
    setloading(true);
...
/////////////////////////////////////////////////////////////////////////////
  ...
  Future sign_in(BuildContext context, String email, String password) async {
    ...
    setloading(false);
    print(response.body);
    print("Store Country: ${prefs.getString('country')}");
    ...
    if (success == 'error') {
      Progress(
        context,
        Text("Invalid credentials were used for access"),
        Colors.red,
      );
    }
  ...
  Future forgot_password(BuildContext context, String phone) async {
    ...
    setloading(true);
    http.Response response = await http.post(
        Uri.parse(ApiConstants.BASE_URL + ApiConstants.FORGOT_PASSWORD),
        headers: {
          'authentication': '@',
          'Content-Type': 'application/x-www-form-urlencoded'
        },
